...
%union {
  ...
  RelAttrAggreSqlNode *             rel_attr_aggre_node;
  std::vector<RelAttrAggreSqlNode> *rel_attr_aggre_list;
...
rel_attr_aggre_list:
      rel_attr_aggre_node
    {
      $$ = new std::vector<RelAttrAggreSqlNode>{*$1}; 
      delete $1; 
    }
