...
public:
   ...
   */
  virtual int init(
      bool dynamic = true, int pool_num = DEFAULT_POOL_NUM, int item_num_per_pool = DEFAULT_ITEM_NUM_PER_POOL
  ) = 0;
...
public:
   ...
   */
  int init(
      int item_size, bool dynamic = true, int pool_num = DEFAULT_POOL_NUM,
